...
# Suite C (#22) sets POSITIONS_GAME_LEVEL_RESTRICTIONS_ENABLED=true when invoking tests.
export POSITIONS_GAME_LEVEL_RESTRICTIONS_ENABLED="${POSITIONS_GAME_LEVEL_RESTRICTIONS_ENABLED:-false}"
