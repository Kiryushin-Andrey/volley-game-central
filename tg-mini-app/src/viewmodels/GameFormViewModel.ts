...
export class GameFormViewModel {
  ...
  async loadDefaultSettings(): Promise<void> {
    try {
      ...
      if (defaults.gameFormat) updates.gameFormat = defaults.gameFormat;
   ...
   */
  handleGameFormatChange(value: GameFormat): void {
    this.updateState({ gameFormat: value });
  }
  ...
  private async createGame(
    ...
    try {
      ...
      await gamesApi.createGame({
        ...
        gameFormat: currentState.gameFormat,
